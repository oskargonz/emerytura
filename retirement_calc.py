def calculate_retirement_age(obecny_wiek, miesieczna_wplata, roczny_zwrot_z_inwestycji, wiek_smierci, inflacja, wartosc_emerytury, kapital_startowy):
    """
    ...
    for wiek_emerytury in range(obecny_wiek, wiek_smierci):
        ...
        for rok in range(lata_emerytury):
            ...
            wyplata_roczna = wartosc_emerytury * 12 * ((1 + inflacja_dec) ** (lata_akumulacji + rok))
